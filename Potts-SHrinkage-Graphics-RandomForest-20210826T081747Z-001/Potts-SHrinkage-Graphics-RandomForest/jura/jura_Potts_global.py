...
with open(r"jura_Partitions_Sets.pkl", "rb") as input_file:
...
def Train_My_Potts_Cluster(Cluster_xtrain,Cluster_ytrain, Cluster_xtest,Cluster_ytest):
    ...
    while (Continue_Principle == 0 ):
            ...
            try:
                ...
                my_qw_evalb = Make_Matrix_Semi_Sparse(my_qw_evalb, l_0,l_1,l_2) # This is for the semi-sparse spnnr model
